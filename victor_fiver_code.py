...
def reuters():
    ...
    # input()
    lock.acquire()
    with SB(undetectable=True,chromium_arg=chrommium_arg,pls='none',headless=True,block_images=True,save_screenshot=True) as sb:
        sb.maximize_window()
...
def abc():
    lock.acquire()
    with SB(undetectable=True,chromium_arg=chrommium_arg,pls='none',headless=True,block_images=True) as sb:
        sb.maximize_window()
...
def theaustralian():
    lock.acquire()
    with SB(undetectable=True,pls='none',block_images=True,headless=True) as sb:
        sb.maximize_window()
