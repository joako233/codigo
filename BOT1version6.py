    ...
    with requests.Session() as session:
        ...
        while True:
            ...
            for articulo in articulos:
                ...
                fecha_publicacion = articulo['published_time']
...
def sydneymorning():
    headers = {
        ...
        'pragma': 'no-cache',
        'priority': 'u=1, i',
        'referer': 'https://www.smh.com.au/',
        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36',
    }

    bussiness = ["companies","markets","the-economy","banking-and-finance","small-business","workplace"]
    categorias = ["business","technology"]
    datos_4= []
    datos_totales = []
    ...
    for categoria in categorias:
        ...
        while True:
            ...
            with requests.Session() as session:
                ...
                while True:
                    if categoria == 'business':
                        respuesta = session.get(f'https://api.smh.com.au/graphql?query=query%20CategoryIndexMoreQuery(%20%24brand%3A%20String!%20%24count%3A%20Int!%20%24path%3A%20String!%20%24since%3A%20ID%20%24types%3A%20%5BString!%5D!%20)%20%7B%20assetsConnection%3A%20assetsConnectionByNavigationPath(brand%3A%20%24brand%2C%20path%3A%20%24path%2C%20count%3A%20%24count%2C%20sinceID%3A%20%24since%2C%20types%3A%20%24types)%20%7B%20...AssetsConnectionFragment_showMoreData%20%7D%20%7D%20fragment%20AssetsConnectionFragment_showMoreData%20on%20AssetsConnection%20%7B%20assets%20%7B%20...AssetFragmentFragment_assetDataWithTag%20id%20%7D%20pageInfo%20%7B%20endCursor%20hasNextPage%20%7D%20%7D%20fragment%20AssetFragmentFragment_assetDataWithTag%20on%20Asset%20%7B%20...AssetFragmentFragment_assetData%20tags%20%7B%20primaryTag%20%7B%20...AssetFragment_tagFragment%20id%20%7D%20%7D%20%7D%20fragment%20AssetFragmentFragment_assetData%20on%20Asset%20%7B%20id%20asset%20%7B%20about%20byline%20duration%20headlines%20%7B%20headline%20%7D%20live%20totalImages%20%7D%20extensions%20label%20urls%20%7B%20canonical%20%7B%20path%20brand%20%7D%20external%20published%20%7B%20brisbanetimes%20%7B%20path%20%7D%20smh%20%7B%20path%20%7D%20theage%20%7B%20path%20%7D%20watoday%20%7B%20path%20%7D%20%7D%20%7D%20featuredImages%20%7B%20landscape16x9%20%7B%20...ImageFragment%20%7D%20landscape3x2%20%7B%20...ImageFragment%20%7D%20portrait2x3%20%7B%20...ImageFragment%20%7D%20square1x1%20%7B%20...ImageFragment%20%7D%20%7D%20assetType%20dates%20%7B%20modified%20published%20%7D%20sponsor%20%7B%20name%20%7D%20%7D%20fragment%20AssetFragment_tagFragment%20on%20AssetTagDetails%20%7B%20displayName%20urls%20%7B%20published%20%7B%20brisbanetimes%20%7B%20path%20%7D%20smh%20%7B%20path%20%7D%20theage%20%7B%20path%20%7D%20watoday%20%7B%20path%20%7D%20%7D%20%7D%20%7D%20fragment%20ImageFragment%20on%20Image%20%7B%20data%20%7B%20animated%20aspect%20autocrop%20cropWidth%20id%20mimeType%20offsetX%20offsetY%20zoom%20%7D%20%7D%20&variables=%7B%22brand%22%3A%22smh%22%2C%22count%22%3A10%2C%22path%22%3A%22%2F{categoria}%2F{x}%22%2C%22{since}%22%3A%22none%3D%22%2C%22types%22%3A%5B%22article%22%2C%22bespoke%22%2C%22collection%22%2C%22featureArticle%22%2C%22gallery%22%2C%22liveArticle%22%2C%22video%22%5D%7D')
                    else:
                        respuesta = session.get(f'https://api.smh.com.au/graphql?query=query%20CategoryIndexMoreQuery(%20%24brand%3A%20String!%20%24count%3A%20Int!%20%24path%3A%20String!%20%24since%3A%20ID%20%24types%3A%20%5BString!%5D!%20)%20%7B%20assetsConnection%3A%20assetsConnectionByNavigationPath(brand%3A%20%24brand%2C%20path%3A%20%24path%2C%20count%3A%20%24count%2C%20sinceID%3A%20%24since%2C%20types%3A%20%24types)%20%7B%20...AssetsConnectionFragment_showMoreData%20%7D%20%7D%20fragment%20AssetsConnectionFragment_showMoreData%20on%20AssetsConnection%20%7B%20assets%20%7B%20...AssetFragmentFragment_assetDataWithTag%20id%20%7D%20pageInfo%20%7B%20endCursor%20hasNextPage%20%7D%20%7D%20fragment%20AssetFragmentFragment_assetDataWithTag%20on%20Asset%20%7B%20...AssetFragmentFragment_assetData%20tags%20%7B%20primaryTag%20%7B%20...AssetFragment_tagFragment%20id%20%7D%20%7D%20%7D%20fragment%20AssetFragmentFragment_assetData%20on%20Asset%20%7B%20id%20asset%20%7B%20about%20byline%20duration%20headlines%20%7B%20headline%20%7D%20live%20totalImages%20%7D%20extensions%20label%20urls%20%7B%20canonical%20%7B%20path%20brand%20%7D%20external%20published%20%7B%20brisbanetimes%20%7B%20path%20%7D%20smh%20%7B%20path%20%7D%20theage%20%7B%20path%20%7D%20watoday%20%7B%20path%20%7D%20%7D%20%7D%20featuredImages%20%7B%20landscape16x9%20%7B%20...ImageFragment%20%7D%20landscape3x2%20%7B%20...ImageFragment%20%7D%20portrait2x3%20%7B%20...ImageFragment%20%7D%20square1x1%20%7B%20...ImageFragment%20%7D%20%7D%20assetType%20dates%20%7B%20modified%20published%20%7D%20sponsor%20%7B%20name%20%7D%20%7D%20fragment%20AssetFragment_tagFragment%20on%20AssetTagDetails%20%7B%20displayName%20urls%20%7B%20published%20%7B%20brisbanetimes%20%7B%20path%20%7D%20smh%20%7B%20path%20%7D%20theage%20%7B%20path%20%7D%20watoday%20%7B%20path%20%7D%20%7D%20%7D%20%7D%20fragment%20ImageFragment%20on%20Image%20%7B%20data%20%7B%20animated%20aspect%20autocrop%20cropWidth%20id%20mimeType%20offsetX%20offsetY%20zoom%20%7D%20%7D%20&variables=%7B%22brand%22%3A%22smh%22%2C%22count%22%3A10%2C%22path%22%3A%22%2F{categoria}%22%2C%22{since}%22%3A%22none%3D%22%2C%22types%22%3A%5B%22article%22%2C%22bespoke%22%2C%22collection%22%2C%22featureArticle%22%2C%22gallery%22%2C%22liveArticle%22%2C%22video%22%5D%7D')

                    diccionario = respuesta.json()

                    lista_assets = diccionario['data']['assetsConnection']['assets']
                
                    contador = 0
                    for asset in lista_assets:
                    
                        dia_publicacion = asset['dates']['published']

                        try:
                            convertida = datetime.strptime(dia_publicacion,'%Y-%m-%dT%H:%M:%SZ').astimezone(timezone.utc)
                        
                        except:
                            dia_publicacion = asset['dates']['published'][:-11]+"Z"
                    ...
                    if contador >=3:
                        ...
                        since = diccionario['data']['assetsConnection']['pageInfo']['endCursor']

                
                for id in ids:
                    url2 = f"https://api.smh.com.au/api/content/v0/assets/{id}"
                    response = session.get(url2)
                    diccionario = response.json()

                    try:
                        cuerpo = diccionario['asset']['body']
                    except:
                        continue
                
                    titulo =  diccionario['asset']['headlines']['headline']
                    link = "https://www.smh.com.au"+diccionario['urls']['canonical']['path']
                    
                    soup = BeautifulSoup(cuerpo,'lxml')
                    ...
                    for p in pes:
                        ...
                        if not p.find('strong') and not p.find('b') and not p.find('span') and not p.find('em'):
                            ...
                            cuerpo_completo = cuerpo_completo + " " + texto_parrafo
                            
                    
                            if contador < 4:
                                contador = contador + 1
                                cuerpo_4 = cuerpo_4 + " " + texto_parrafo
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    ...
    futures.append(executor.submit(sydneymorning))
